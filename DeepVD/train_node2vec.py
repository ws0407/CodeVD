...
def read_graphs(input_path):
    ii = 0
    graphs = []
    all_file = findAllFile(input_path, True)
    for file in tqdm(all_file, desc="Processing"):
        ...
        if not os.path.exists(edges_file):
            print("== no edges file: {}".format(edges_file))
            continue
...
class Node2vec():
    ...
    def train(self, graphs):
        ...
        print("training node2vec done, saved to: {}".format(self.model_path))
    ...
    def get_embedding(self, func_key):
        ...
        if func_key in self.model.wv:
            ...
            print("node2vec - no such a key: {}".format(func_key))
        return None
...
if __name__ == '__main__':
    # Test:
    INPUT_PATH = "/data/data/ws/CodeVD/DeepVD/data/BigVul_data"
    OUTPUT_PATH = "/data/data/ws/CodeVD/DeepVD/data/output"
